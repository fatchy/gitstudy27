...
#star1 {
	...
	-webkit-animation: star1 12s infinite linear, star1-fade 12s infinite
		ease-in-out;
	-moz-animation: star1 12s infinite linear, star1-fade 12s infinite
		ease-in-out;
	-o-animation: star1 12s infinite linear, star1-fade 12s infinite
		ease-in-out;
	animation: star1 12s infinite linear, star1-fade 12s infinite
		ease-in-out;
}

#star2 {
	transform-origin: 489px 82px;
	-webkit-animation: star2 12s infinite linear, star2-fade 12s infinite
		ease-in-out;
	-moz-animation: star2 12s infinite linear, star2-fade 12s infinite
		ease-in-out;
	-o-animation: star2 12s infinite linear, star2-fade 12s infinite
		ease-in-out;
	animation: star2 12s infinite linear, star2-fade 12s infinite
		ease-in-out;
}

#star3 {
	transform-origin: 316px 344px;
	-webkit-animation: star3 12s infinite linear, star3-fade 12s infinite
		ease-in-out;
	-moz-animation: star3 12s infinite linear, star3-fade 12s infinite
		ease-in-out;
	-o-animation: star3 12s infinite linear, star3-fade 12s infinite
		ease-in-out;
	animation: star3 12s infinite linear, star3-fade 12s infinite
		ease-in-out;
}

#star4 {
	transform-origin: 126px 182px;
	-webkit-animation: star4 12s infinite linear, star4-fade 12s infinite
		ease-in-out;
	-moz-animation: star4 12s infinite linear, star4-fade 12s infinite
		ease-in-out;
	-o-animation: star4 12s infinite linear, star4-fade 12s infinite
		ease-in-out;
	animation: star4 12s infinite linear, star4-fade 12s infinite
		ease-in-out;
}
...
@
-webkit-keyframes star2-fade { 0%,15% {
	opacity: 0;
}
...
@
-webkit-keyframes star3-fade { 0%,30% {
	opacity: 0;
}
...
@
-webkit-keyframes star4-fade { 0%,45% {
	opacity: 0;
}
...
@
-webkit-keyframes tetris-float { 0% {
...
@
-webkit-keyframes triforce-float { 0% {
	-webkit-transform: translate(0px, 0px) scale(0.90)
}
...
@
-moz-keyframes triforce-float { 0% {
	-moz-transform: translate(0px, 0px) scale(0.90)
}
...
<body>
	...
	<svg class="me404" viewbox="0 0 1000 480"> <path id="cloud"
		class="st0"
	...
	<g id="triforce"> <path id="zelda_stroke" class="st1"
	...
	</g> <g id="monkey"> <path id="foot_back" class="st4"
	...
	<g id="monkey_arm"> <path id="monkey-arm" class="st5"
	...
	<path class="st11" d="M146.6,295.1c0,0,10.8-1.4,16.7,9.6" /> <path
		class="st11" d="M144.4,296c0,0,8.7-6.6,19.2,0" /> </g> </g> </g> <g
		id="tetris-path"> <g id="tetris"> <path id="tetris_stroke"
		class="st13"
	...
	</g> </g> <g id="stars"> <path id="star1" class="st5"
	...
	</g> <g id="moon"> <path id="moon_body" class="st5"
	...
	</g> <g id="number_4"> <path id="number_4_outline" class="st1"
	...
	</g> <g id="number_4_2"> <path id="number_4_outline_2" class="st1"
	...
	</g> <g id="number_0"> <path id="number_0_outline" class="st1"
	...
	</g> <g id="sword-path"> <g id="sword"> <path id="sword_handle"
		class="st5"
	...
	<polygon id="sword_blade" class="st1"
		points="437,199 446,187.3 387.3,138.9 366.3,136.7 372.2,154 	" /> <polygon
		id="sword_blade_shadow" class="st0"
		points="436.7,197 440.3,192.3 369,138.5 368.5,138.4 373.5,153 	" /> </g>
	</g> </svg>
	<script>
