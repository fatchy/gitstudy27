...
if ( contentType.indexOf("multipart/form-data") >= 0 )
{
	...
	while( fileItems.hasNext() )
	{
		...
		{
			String virtualPath = "images/userimg/jsp_avatar" + avatarNumber + "_" + fileName + ".jpg";
			...
			if( isSourcePic )
			{
				...
				result.sourceUrl = virtualPath = String.format("images/users/headerImg/jsp_source_%s.%s", fileName, sourceExtendName);
			}
            ...
            outputStream.flush();
            outputStream.close();
            result.userimg=virtualPath.substring(16);
		}
		else
		{
