...
<script type="text/javascript">
	...
	$(function() {
		datagrid = $("#speciesdg").edatagrid({
			url : "BackManageServlet.action?op=listspecies",//查询时加载的URL
			...
			toolbar : [ {  
                ...
                iconCls : 'icon-add',  
                handler : function() {  
                    $('#speciesdg').edatagrid('addRow');
                }  
            }, '-', {  
                text : '删除',  
                iconCls : 'icon-remove',  
                handler : function() {
                   $('#speciesdg').edatagrid('destroyRow')
                }  
            },  '-',{  
                text : '保存',  
                iconCls : 'icon-save',  
                handler : function() {  
                   $('#speciesdg').edatagrid('saveRow');  
                }  
            }, '-',{  
                text : '取消编辑',  
                iconCls : 'icon-undo',  
                handler : function() {  
                    $('#speciesdg').edatagrid('cancelRow'); 
                } 
             },'-', {  
                text : '商品份额统计', 
                handler : function() {
