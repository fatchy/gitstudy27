...
<script type="text/javascript">
	...
	$(function() {
		datagrid = $("#gooddg").edatagrid({
			url : "BackManageServlet.action?op=listgoodsadver",//查询时加载的URL
			saveUrl: "BackManageServlet.action?op=addgoodsadver",
			destroyUrl: "BackManageServlet.action?op=deletegoodsadver",
			updateUrl: "BackManageServlet.action?op=updategoodsadver",
